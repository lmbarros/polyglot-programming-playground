/**
 * Implementation of the SHA-256 digest. Based on the pseudocode provided by the
 * $(LINK2 http://en.wikipedia.org/w/index.php?title=SHA-2&oldid=478219252,Wikipedia
 * article on SHA-2).
 *
 * Author: Leandro Motta Barros
 *
 * Copyright: Copyright © 2012, Leandro Motta Barros. All rights reserved.
 *
 * License: The Cursing License.
 */
module sha256;
...
class SHA256
{
   public:
      ...
      void addData(ubyte[] data)
      {
         ...
         assert(chunk_.length < 64, "chunk_ unexpectedly large");
      ...
      string finish()
      {
         assert(chunk_.length < 64,
                "processChunk() should have been called before");
         ...
         assert(chunk_.length == 0, "All data should have been processed");
   ...
   private:
      ...
      void processChunk()
      {
         assert(chunk_.length * 8 == 512,
                "Unexpected amount of data in 'chunk_'");
         ...
         foreach (i; 16..64)
         {
            immutable uint s0 = rightRotate!(7)(w[i-15]) ^ rightRotate!(18)(w[i-15]) ^ (w[i-15] >> 3);
            immutable uint s1 = rightRotate!(17)(w[i-2]) ^ rightRotate!(19)(w[i-2]) ^ (w[i-2] >> 10);
         ...
         foreach(i; 0..64)
         {
            immutable uint s0 = rightRotate!(2)(a) ^ rightRotate!(13)(a) ^ rightRotate!(22)(a);
            immutable uint maj = (a & b) ^ (a & c) ^ (b & c);
            immutable uint t2 = s0 + maj;
            immutable uint s1 = rightRotate!(6)(e) ^ rightRotate!(11)(e) ^ rightRotate!(25)(e);
      ...
      {
         auto s = new SHA256();
         assert(s.rightRotate!(0)(0b0000_0000_1001_0000_0000_0000_0000_0000)
                == 0b0000_0000_1001_0000_0000_0000_0000_0000);

         assert(s.rightRotate!(1)(0b0000_0000_0000_0000_0000_0000_0000_0000)
                == 0b0000_0000_0000_0000_0000_0000_0000_0000);

         assert(s.rightRotate!(1)(0b0000_1000_0000_0000_0000_0000_0000_0000)
                == 0b0000_0100_0000_0000_0000_0000_0000_0000);

         assert(s.rightRotate!(1)(0b0000_0000_0000_0000_0000_0000_0000_0001)
                == 0b1000_0000_0000_0000_0000_0000_0000_0000);

         assert(s.rightRotate!(1)(0b0000_1000_0000_1001_0000_0000_0000_0011)
                == 0b1000_0100_0000_0100_1000_0000_0000_0001);

         assert(s.rightRotate!(2)(0b0000_1000_0000_1001_0000_0000_0000_0011)
                == 0b1100_0010_0000_0010_0100_0000_0000_0000);

         assert(s.rightRotate!(3)(0b0000_1000_0000_1001_0000_0000_0000_0011)
                == 0b0110_0001_0000_0001_0010_0000_0000_0000);

         assert(s.rightRotate!(11)(0b0000_0000_0000_0000_0000_0000_1000_0000)

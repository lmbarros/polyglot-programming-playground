...
uint RightRotate(uint n, uint amount)
{
   foreach (i; 0..amount)
   {
...
unittest
{
   ...
   assert(RightRotate(0b0000_0000_1001_0000_0000_0000_0000_0000, 0)
                   == 0b0000_0000_1001_0000_0000_0000_0000_0000);

   assert(RightRotate(0b0000_0000_0000_0000_0000_0000_0000_0000, 1)
                   == 0b0000_0000_0000_0000_0000_0000_0000_0000);

   assert(RightRotate(0b0000_1000_0000_0000_0000_0000_0000_0000, 1)
                   == 0b0000_0100_0000_0000_0000_0000_0000_0000);

   assert(RightRotate(0b0000_0000_0000_0000_0000_0000_0000_0001, 1)
                   == 0b1000_0000_0000_0000_0000_0000_0000_0000);

   assert(RightRotate(0b0000_1000_0000_1001_0000_0000_0000_0011, 1)
                   == 0b1000_0100_0000_0100_1000_0000_0000_0001);

   assert(RightRotate(0b0000_1000_0000_1001_0000_0000_0000_0011, 2)
                   == 0b1100_0010_0000_0010_0100_0000_0000_0000);

   assert(RightRotate(0b0000_1000_0000_1001_0000_0000_0000_0011, 3)
                   == 0b0110_0001_0000_0001_0010_0000_0000_0000);

   assert(RightRotate(0b0000_0000_0000_0000_0000_0000_1000_0000, 11)
...
class SHA256
{
   ...
   private:
      ...
      body
      {
         ...
         foreach (i; 16..64)
         {
            immutable uint s0 = RightRotate(w[i-15], 7)
               ^ RightRotate(w[i-15], 18)
               ^ (w[i-15] >> 3);
            immutable uint s1 = RightRotate(w[i-2], 17)
         ...
         foreach(i; 0..64)
         {
            immutable uint s0 = RightRotate(a, 2)
               ^ RightRotate(a, 13)
               ^ RightRotate(a, 22);
            immutable uint maj = (a & b) ^ (a & c) ^ (b & c);
            immutable uint t2 = s0 + maj;
            immutable uint s1 = RightRotate(e, 6)
               ^ RightRotate(e, 11)
               ^ RightRotate(e, 25);
